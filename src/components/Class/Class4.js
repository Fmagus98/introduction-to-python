                ...
                <div id="element5" className={`mt-4 rounded-5 animated-left ${elementVisibility.element5 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPython, borderRadius: "40px" }}>
                  ...
                  <div id="a4" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/module1.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/module2.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/module3.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block" style={{ marginBottom: "7rem" }} alt="" src="../img/class4/module4.webp"></img>
                    </div>
                  </div>
                </div>
                <div id="element6" className={`mt-4 rounded-5 animated-left ${elementVisibility.element6 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPython, borderRadius: "40px" }}>
                  ...
                  <div id="a5" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/math1.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/math2.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/math3.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/math4.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/math5.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/random1.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/random2.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/random3.webp"></img>
                      <p className="text-break mx-auto w-75"><span className="fw-bold">Choice: </span>Selecciona un elemento aleatorio de una lista.</p>
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/random4.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/random5.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/datetime1.webp"></img>
                      <p className="text-break mx-auto w-75"><span className="fw-bold">Datetime.date(): </span>Crea un objeto de fecha específica.</p>
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/datetime2.webp"></img>
                      <p className="text-break mx-auto w-75"><span className="fw-bold">Datetime.time(): </span>Crear un objeto de tiempo específico.</p>
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/datetime3.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/datetime4.webp"></img>
                      ...
                      <img className="w-75 mx-auto d-block mb-4" alt="" src="../img/class4/datetime5.webp"></img>
                      <p className="text-break mx-auto w-75">Tambien puedes obtener la fecha y hora de forma individual</p>
                      <img className="w-75 mx-auto d-block" style={{ marginBottom: "7rem" }} alt="" src="../img/class4/datetime6.webp"></img>
                    </div>
                  </div>
                </div>
