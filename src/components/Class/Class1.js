                                ...
                                <div data-aos="fade-right" className="accordion-item rounded-5" style={{ background: "#010483" }} >
                                    ...
                                    <div id="a1" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                        <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                                            ...
                                            <img className="mx-auto d-block w-75" alt="" src='../img/class1/btot.webp' />
                                            <h3 className="text-center mx-auto mt-4" style={{ fontSize: "25px", fontWeight: "700" }}>REPRESENTACIÓN DE TEXTO EN CÓDIGO BINARIO</h3>
                                            <img className="mx-auto d-block w-75" alt="" src='../img/class1/btot2.webp' />
                                            ...
                                            <img className="w-75 mx-auto d-block" alt="" src='../img/class1/PMg.webp' />
                                            ...
                                            <img className="w-75 mx-auto d-block" style={{ marginBottom: "7rem" }} alt="" src='../img/class1/cvsi.webp' />
                                        </div>
                                    </div>
                                </div>
