              ...
              <div id="a1" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  <div className="accordion-body text-light">
                    ...
                    <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/variable.webp"></img>
                  </div>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a2" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" alt="" src="../img/clase2/namingConventions.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" alt="" src="../img/clase2/practice.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/letterNot.webp"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a3" className="accordion-collapse collapse bg-dark" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light">
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/boolean.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/int.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/str.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/type.webp"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a4" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/opArit.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/opComp.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/opLog.webp"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a5" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" alt="" src="../img/clase2/convType.webp"></img>
            ...
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a6" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" alt="" style={{ marginBottom: "7rem" }} src="../img/clase2/f-string.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/format.webp"></img>
                  <h2 className="text-center mx-auto">Repr</h2>
                  <p className="text-center mx-auto w-75">El método format() se llama en una cadena y toma uno o más argumentos que se utilizan para completar marcadores de posición dentro de la cadena. Estos marcadores de posición se definen utilizando llaves { } en la cadena y se reemplazan por los valores correspondientes.
                  </p>
                  <img className="w-75 d-block mx-auto" alt="" src="../img/clase2/repr.webp" style={{ marginBottom: "7rem" }}></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a7" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/lower.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/upper.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/islower.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/isupper.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/isdigit.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/isalpha.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/capitalize.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/center.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/strip.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/count.webp"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/endswith.webp"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
