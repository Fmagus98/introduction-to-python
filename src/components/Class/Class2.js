              ...
              <div id="a1" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  <div className="accordion-body text-light">
                    ...
                    <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/variable.png"></img>
                  </div>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a2" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/letterNot.png"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a3" className="accordion-collapse collapse bg-dark" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light">
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/boolean.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/int.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/str.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/type.png"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a4" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/opArit.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/opComp.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/opLog.png"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
            ...
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a6" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" alt="" style={{ marginBottom: "7rem" }} src="../img/clase2/f-string.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/format.png"></img>
            ...
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
              ...
              <div id="a7" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div className="accordion-body text-light bg-dark rounded-5 rounded-top">
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/lower.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/upper.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/islower.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/isupper.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/isdigit.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/isalpha.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/center.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/strip.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/count.png"></img>
                  ...
                  <img className="w-75 d-block mx-auto" style={{ marginBottom: "7rem" }} alt="" src="../img/clase2/endswith.png"></img>
                </div>
              </div>
            </div>
            <div className="accordion-item mt-4 rounded-5" style={{ background: "#010483" }}>
