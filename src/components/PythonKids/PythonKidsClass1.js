...
import { pythonKidsClass1Code } from './pythonKidsClassCode'


const PythonKidsClass1 = () => {
                        ...
                        <div className="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                            <div>
                                ...
                                <div className="text-center text-lg-start">
                                    <a href="#class1" className={`btn-get-started scrollto python-theme`} style={{background:colorSecondaryPythonKids}}>Contenido de la Clase 1</a>
                                </div>
                            </div>
                        </div>
            ...
            <section className="section-bg">
                <div className="container">
                    ...
                    <div className="accordion accordion-flush w-100 mx-auto" id="accordionFlushExample">
                        <div id="element2" className={`accordion-item animated-left ${elementVisibility.element2 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }} >
                        ...
                        <div id="element3" className={`accordion-item mt-4  animated-left ${elementVisibility.element3 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element4" className={`accordion-item mt-4  animated-left ${elementVisibility.element4 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element5" className={`accordion-item mt-4  animated-left ${elementVisibility.element5 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element6" className={`accordion-item mt-4  animated-left ${elementVisibility.element6 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element7" className={`accordion-item mt-4  animated-left ${elementVisibility.element7 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element8" className={`accordion-item mt-4  animated-left ${elementVisibility.element8 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element9" className={`accordion-item mt-4  animated-left ${elementVisibility.element9 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element10" className={`accordion-item mt-4  animated-left ${elementVisibility.element10 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element11" className={`accordion-item mt-4  animated-left ${elementVisibility.element11 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                        ...
                        <div id="element12" className={`accordion-item mt-4  animated-left ${elementVisibility.element12 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                            ...
                            <div id="a11" className="accordion-collapse collapse" >
                                <div className="accordion-body text-light bg-dark">
                                    ...
                                    <CopyButton code={pythonKidsClass1Code[0]} />
                                    ...
                                    <CopyButton code={pythonKidsClass1Code[1]} />
                                    ...
                                    <CopyButton code={pythonKidsClass1Code[2]} />
                                    ...
                                    <CopyButton code={pythonKidsClass1Code[3]} />
                                    <img className="w-75 d-block mx-auto  border-content" style={{ marginBottom: "7rem" }} alt="" src="../../img/class1/p10.webp"></img>
                                </div>
                            </div>
                        </div>
                        <div id="element13" className={`accordion-item mt-4  animated-left ${elementVisibility.element13 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
...
export default PythonKidsClass1
