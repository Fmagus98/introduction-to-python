...
import { pythonKidsClass3Code, pythonKidsClass5Code } from './pythonKidsClassCode'
import QuizForm from '../QuizForm/QuizForm';

const PythonKidsClass5 = () => {
              ...
              <div className="row justify-content-between">
                <div className="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                  <div>
                    ...
                    <a href="#class5" className={`btn-get-started scrollto python-theme`} style={{background:colorSecondaryPythonKids}}>Contenido de la Clase 5</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="a1" className="accordion-collapse collapse" >
                    <div className="accordion-body text-light bg-dark ">
                      <div className="accordion-body text-light">
                        ...
                        <CopyButton code={pythonKidsClass5Code[0]} />
                        ...
                        <CopyButton code={pythonKidsClass5Code[1]} />
                        ...
                        <CopyButton code={pythonKidsClass5Code[2]} />
                        ...
                        <CopyButton code={pythonKidsClass5Code[3]} />
                        ...
                        <CopyButton code={pythonKidsClass5Code[4]} />
                ...
                <div id="element3" className={`mt-4 rounded-5 animated-left ${elementVisibility.element3 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                  ...
                  <div id="a2" className="accordion-collapse collapse bg-dark" >
                    <div className="accordion-body text-light bg-dark ">
                      ...
                      <CopyButton code={pythonKidsClass5Code[5]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[6]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[7]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[8]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[9]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[10]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[11]} />
                ...
                <div id="element4" className={`mt-4 rounded-5 animated-left ${elementVisibility.element4 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                  ...
                  <div id="a3" className="accordion-collapse collapse bg-dark" >
                    <div className="accordion-body text-light bg-dark ">
                      ...
                      <CopyButton code={pythonKidsClass5Code[12]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[13]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[14]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[15]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[18]} />
                ...
                <div id="element5" className={`mt-4 rounded-5 animated-left ${elementVisibility.element5 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                  ...
                  <div id="a4" className="accordion-collapse collapse" >
                    <div className="accordion-body text-light bg-dark ">
                      ...
                      <CopyButton code={pythonKidsClass5Code[19]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[20]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[21]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[22]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[23]} />
                      ...
                      <CopyButton code={pythonKidsClass5Code[24]} />
                ...
                <div id="element6" className={`mt-4 rounded-5 animated-left ${elementVisibility.element6 ? 'slide-left' : ''}`} style={{ background: colorPrimaryPythonKids, borderRadius: "40px" }}>
                  ...
                  <div id="a5" className="accordion-collapse collapse" >
                    <div className="accordion-body text-light bg-dark ">
                      ...
                      <CopyButton code={pythonKidsClass3Code[9]} />
                      ...
                      <CopyButton code={pythonKidsClass3Code[10]} />
...
export default PythonKidsClass5
